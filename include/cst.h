...
#define CST_KIND_LIST                               \
    ...
    XX(CST_MAKE_EXPR, "MakeExpr")                   \
    XX(CST_STRUCT_INIT_EXPR, "StructInitExpr")      \
    XX(CST_STRUCT_INIT_ENTRY, "StructInitEntry")    \
    XX(CST_ANYOF_INIT_EXPR, "AnyOfInitExpr")        \
    ...
    XX(CST_LITERAL_EXPR, "LiteralExpr")             \
                                                    \
    XX(CST_TYPE_DEF, "TypeDef")                     \
    XX(CST_TYPE_DEF_NAME, "TypeDefName")            \
    XX(CST_TYPE_DEF_PARAM_LIST, "TypeDefParamList") \
    XX(CST_TYPE_DEF_PARAM, "TypeDefParam")          \
    XX(CST_STRUCT_DEF, "StructDef")                 \
    XX(CST_STRUCT_ENTRY_LIST, "StructEntryList")    \
    XX(CST_STRUCT_ENTRY, "StructEntry")             \
    XX(CST_ANYOF_DEF, "AnyOfDef")                   \
    XX(CST_ANYOF_ENTRY_LIST, "AnyOfEntryList")      \
    XX(CST_ANYOF_ENTRY, "AnyOfEntry")
